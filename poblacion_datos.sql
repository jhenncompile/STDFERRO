...
-- PASO 1: INFRAESTRUCTURA (Sin cambios)
...
-- ====================================================================================
-- PASO 2: FLOTA Y PERSONAL (ADAPTADO A BANDERAS)
-- ====================================================================================

INSERT INTO ROL (Nombre, Sueldo_Base) VALUES ('Taquillero', 2800.00), ('Conductor', 3500.00);

-- CAMBIO AQUI: Usamos Es_Empleado = 1
INSERT INTO PERSONA (Nombre, Apellidos, CI_Documento, Celular, Es_Empleado) VALUES 
('Juan', 'Perez', '1001', '7001001', 1), 
('Ana', 'Lopez', '1002', '7001002', 1);
...
BEGIN
    -- CAMBIO AQUI: Usamos Es_Empleado = 1
    INSERT INTO PERSONA (Nombre, Apellidos, CI_Documento, Es_Empleado) VALUES 
    (CONCAT('Conductor', @c), 'Ferroviario', CONCAT('C-', @c), 1);
...
-- ====================================================================================
-- PASO 3: CATÁLOGOS Y PASAJEROS (ADAPTADO A BANDERAS)
-- ====================================================================================
...
-- 2. Crear Clientes (CAMBIO: Usamos Es_Cliente = 1)
INSERT INTO PERSONA (Nombre, Apellidos, CI_Documento, Celular, Es_Cliente) VALUES 
('Cliente', 'Ventanilla', '0000000', '0', 1),
('Agencia', 'Turismo Bol', 'NIT-1001', '7000001', 1),
('Empresa', 'Minera San Cristobal', 'NIT-2002', '7000002', 1),
('Colegio', 'La Salle', 'NIT-3003', '7000003', 1),
('Hotel', 'Los Tajibos', 'NIT-4004', '7000004', 1);

INSERT INTO CLIENTE (ID_Cliente, Nit, Razon_Social)
SELECT ID_Persona, CI_Documento, CONCAT(Nombre, ' ', Apellidos)
FROM PERSONA 
WHERE Es_Cliente = 1; -- Filtramos por la bandera

-- 3. GENERACIÓN MASIVA DE PASAJEROS
DECLARE @Nombres TABLE (Nombre VARCHAR(50));
INSERT INTO @Nombres VALUES ('Juan'), ('Ana'), ('Carlos'), ('Maria'), ('Luis'), ('Sofia'), ('Jorge'), ('Lucia'), ('Pedro'), ('Paula'), ('Diego'), ('Valeria'); 
...
BEGIN
    ...
    -- CAMBIO AQUI: Usamos Es_Pasajero = 1
    INSERT INTO PERSONA (Nombre, Apellidos, CI_Documento, Celular, Es_Pasajero) 
    VALUES (@Nom, @Ape, @CI, CONCAT('7', 0000000 + @p), 1);
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUES (@ID_Venta, @PasajeroRandom, @ID_Tren_Itinerario, ID_Asiento, ID_Estacion_Origen, ID_Estacion_Destino, Precio_Final, Estado);
